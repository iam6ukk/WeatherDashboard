...
declare const IgcDateTimeInputComponent_base: AbstractConstructor<import("../common/mixins/event-emitter.js").EventEmitterInterface<IgcDateTimeInputEventMap>> & AbstractConstructor<IgcMaskInputBaseComponent>;
/**
