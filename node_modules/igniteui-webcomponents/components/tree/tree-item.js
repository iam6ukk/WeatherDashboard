...
let IgcTreeItemComponent = class IgcTreeItemComponent extends LitElement {
    ...
    connectedCallback() {
        ...
        this.parent = (_a = this.parentElement) === null || _a === void 0 ? void 0 : _a.closest('igc-tree-item');
    ...
    get directChildren() {
        return this.allChildren.filter((x) => {
            var _a, _b, _c;
            return (_c = ((_a = x.parent) !== null && _a !== void 0 ? _a : (_b = x.parentElement) === null || _b === void 0 ? void 0 : _b.closest('igc-tree-item'))) === null || _c === void 0 ? void 0 : _c.isSameNode(this);
        });
    }
    get allChildren() {
...
], IgcTreeItemComponent.prototype, "group", void 0);
__decorate([
    state()
