...
:host {
  ...
  --selected-item-text-color: var(--ig-drop-down-selected-item-text-color, var(--ig-gray-100-contrast));
  --selected-hover-item-background: var(--ig-drop-down-selected-hover-item-background, hsla(var(--ig-gray-100), var(--ig-gray-a)));
  --selected-hover-item-text-color: var(--ig-drop-down-selected-hover-item-text-color, var(--ig-gray-200-contrast));
  --selected-focus-item-background: var(--ig-drop-down-selected-focus-item-background, hsla(var(--ig-gray-200), var(--ig-gray-a)));
  --selected-focus-item-text-color: var(--ig-drop-down-selected-focus-item-text-color, var(--ig-gray-200-contrast));
